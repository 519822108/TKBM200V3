...
static QString msg_global_ver[2] = {QString("27930-2111"),QString("27930-2015")};
...
static QString msg_bms_rcv_err[7] = {QString("CRM error"),QString("CML error"),QString("CRO error"),QString("CCS error"),QString("CST error"),QString("CSD error"),QString(" ")};
static QString msg_chg_rcv_err[8] = {QString("BRM error"),QString("BCP error"),QString("BRO error"),QString("BCS error"),QString("BCL error"),QString("BST error"),QString("BSD error"),QString(" ")};
