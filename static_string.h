...
static const QString msg_alart_level[4] = {QString("无报警\0"),QString("一级报警\0"),QString("二级报警\0"),QString("三级报警\0")};
static const QString msg_alart_list[5][4] = { {QString("绝缘过低\t"),QString("内CAN故障\t"),QString("从板故障\t"),QString("EEP故障\t")},
...
static const QString msg_connector_state[16] = {QString("自检中\0"),QString("接触器吸合\0"),QString("单体过压保护\0"),QString("单体欠压保护\0"),
...
static const QString msg_chg_state[4] = {QString("放电状态中\0"),QString("充电枪连接,未充电\0"),QString("充电枪连接,充电中\0"),QString("非充电枪,充电中\0")};

static const QString msg_cc2_state[2] = {QString("未可靠连接\0"),QString("可靠连接\0")};
static const QString msg_global_ver[2] = {QString("27930-2111"),QString("27930-2015")};
static const QString msg_need_mode[4] = {QString("禁止充电\0"),QString("恒压充电\0"),QString("恒流充电\0"),QString("ERROR")};

static QString msg_chg_stage[CHG_STAGE_ARRAY_SIZE];
static const QString msg_bms_stop_chg[9] = {QString("达到总压上限\0"),QString("达到单体上限\0"),QString("受到充电机CST"),QString("绝缘电阻过低\0"),
                                      QString("电池过温\0"),QString("CC2信号异常\0"),QString("电流异常\0"),QString("从板离线\0"),QString(" ")};
static const QString msg_chg_stop_err[5] = {QString("达到充电设定\0"),QString("人工中止\0"),QString("故障中止\0"),QString("BMS主动中止\0"),QString(" ")};
static const QString msg_chg_stop_fat[9] = {QString("充电机过温\0"),QString("连接器故障\0"),QString("充电机内部过温\0"),QString("电量不能传送\0"),
...
static const QString msg_state_enable[2] = {QString("使能\0"),QString("禁止\0")};
static const QString msg_ac_chg_state_a[8] = {QString("未开始\0"),QString("充电中\0"),QString("接触器断开,充电停止\0"),QString("报警,充电停止\0"),
